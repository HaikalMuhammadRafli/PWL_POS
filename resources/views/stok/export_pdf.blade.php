        ...
        <table class="border-all">
            <thead>
                <tr>
                    ...
                    <th class="text-center">Supplier Stok</th>
                    <th class="text-center">Barang Stok</th>
                    <th class="text-center">User Stok</th>
            ...
            <tbody>
                @foreach ($stoks as $s)
                    <tr>
                        ...
                        <td class="text-center">{{ $s->supplier->supplier_nama }}</td>
                        <td class="text-center">{{ $s->barang->barang_nama }}</td>
                        <td class="text-center">{{ $s->user->nama }}</td>
